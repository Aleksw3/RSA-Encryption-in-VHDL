...
-- Date        : Thu Nov 12 15:18:06 2020
-- Host        : aleksw running 64-bit Ubuntu 18.04.03 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/aleksw/Documents/tfe4141_rsa_integration_kit_2020/RSA_soc/boards/ip/rsa_soc_processing_system7_0_0/rsa_soc_processing_system7_0_0_sim_netlist.vhdl
...
entity rsa_soc_processing_system7_0_0_processing_system7_v5_5_processing_system7 is
  ...
  attribute C_USE_S_AXI_HP0 of rsa_soc_processing_system7_0_0_processing_system7_v5_5_processing_system7 : entity is 0;
  ...
  attribute POWER of rsa_soc_processing_system7_0_0_processing_system7_v5_5_processing_system7 : entity is "<PROCESSOR name={system} numA9Cores={2} clockFreq={666.666666} load={0.5} /><MEMORY name={code} memType={DDR3} dataWidth={32} clockFreq={533.333333} readRate={0.5} writeRate={0.5} /><PLL domain={Processor} vco={1320,000} /><PLL domain={Memory} vco={1056,000} /><PLL domain={IO} vco={1584,000} /><AXI interface={M_AXI_GP0} dataWidth={32} clockFreq={10} usageRate={0.5} />/>";
...
entity rsa_soc_processing_system7_0_0 is
  ...
  attribute X_CORE_INFO of rsa_soc_processing_system7_0_0 : entity is "processing_system7_v5_5_processing_system7,Vivado 2019.2";
...
architecture STRUCTURE of rsa_soc_processing_system7_0_0 is
  ...
  attribute POWER : string;
  attribute POWER of inst : label is "<PROCESSOR name={system} numA9Cores={2} clockFreq={666.666666} load={0.5} /><MEMORY name={code} memType={DDR3} dataWidth={32} clockFreq={533.333333} readRate={0.5} writeRate={0.5} /><PLL domain={Processor} vco={1320,000} /><PLL domain={Memory} vco={1056,000} /><PLL domain={IO} vco={1584,000} /><AXI interface={M_AXI_GP0} dataWidth={32} clockFreq={10} usageRate={0.5} />/>";
  attribute USE_TRACE_DATA_EDGE_DETECTOR : integer;
  ...
  attribute X_INTERFACE_PARAMETER of FCLK_CLK0 : signal is "XIL_INTERFACENAME FCLK_CLK0, FREQ_HZ 49500000, PHASE 0.000, CLK_DOMAIN rsa_soc_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
