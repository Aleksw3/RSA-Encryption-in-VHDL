...
(* CORE_GENERATION_INFO = "bd_ae75,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_ae75,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=0,numReposBlks=0,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "rsa_soc_axi_smc_0.hwdef" *) 
module bd_ae75
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
